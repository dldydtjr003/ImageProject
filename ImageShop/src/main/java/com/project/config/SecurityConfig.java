...
public class SecurityConfig {
	...
	SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
		 ...
		 * 로그아웃을 처리할 URL (기본값: /logout) .logoutSuccessUrl("/login") // 로그아웃 성공 시 이동할 페이지
		 ...
		 */
		/*
		 * // 6. 자동 로그인(Remember-Me) 설정 수정 httpSecurity.rememberMe(remember ->
		 * remember.key("zeus") // 인증 토큰 생성 시 사용할 키 (보안상 중요)
