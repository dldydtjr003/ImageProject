...
import com.project.service.ChargeCoinService;
...
@Slf4j
@RequestMapping("/coin")
public class ChargeCoinController {

	@Autowired
	private ChargeCoinService service;
	...
	public String charge(ChargeCoin chargeCoin, RedirectAttributes rttr, Authentication authentication)
		...
		if (count != 0) {
			...
			rttr.addFlashAttribute("msg", "충전이 실패되었습니다.");
		}
